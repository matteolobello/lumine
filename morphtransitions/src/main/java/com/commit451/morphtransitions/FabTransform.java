...
public class FabTransform extends Transition {
    ...
    private static final String EXTRA_FAB_ICON_TINT_COLOR = "EXTRA_FAB_ICON_TINT_COLOR";
    ...
    private final int fabIconTintColor;

    public FabTransform(int fabColor, int fabIconResId, int fabIconTintColor) {
        color = fabColor;
        icon = fabIconResId;
        this.fabIconTintColor = fabIconTintColor;
     ...
     */
    public static void addExtras(Intent intent, int fabColor, int fabIconResId, int fabTintColor) {
        intent.putExtra(EXTRA_FAB_COLOR, fabColor);
        intent.putExtra(EXTRA_FAB_ICON_RES_ID, fabIconResId);
        intent.putExtra(EXTRA_FAB_ICON_TINT_COLOR, fabTintColor);
    }
     ...
     */
    public static boolean setup(Activity activity, View target) {
        ...
        final int iconTintColor = intent.getIntExtra(EXTRA_FAB_ICON_TINT_COLOR, -1);
        final FabTransform sharedEnter = new FabTransform(color, icon, iconTintColor);
        if (target != null) {
    ...
    public Animator createAnimator(final ViewGroup sceneRoot,
        ...
        final Drawable fabIcon =
                sceneRoot.getContext().getResources().getDrawable(icon).mutate();
        fabIcon.setColorFilter(fabIconTintColor, PorterDuff.Mode.SRC_ATOP);
